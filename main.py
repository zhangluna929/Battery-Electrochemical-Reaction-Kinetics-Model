"""
This file is deprecated and remains for historical purposes.
Please use the command-line interface via `battery_kinetics/cli.py`.

To run a simulation, see the instructions in README.md.
Example:
python -m battery_kinetics.cli run params.yml --model 0d_bv
"""

raise DeprecationWarning(
    "main.py is deprecated. Use the CLI `python -m battery_kinetics.cli ...` instead."
)
